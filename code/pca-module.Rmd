...
params:
    ...
    pca_comp1: "30%"
    pca_comp2: "12%"
    f_value: "0.85366"  # "f-value" (as opposed to "f_value") can't be rendered properly for some reason!  
    r_squared: "0.078652"
    p_value: "0.457"
--- 
...
scores_plot_path <- paste0("~/Desktop/Download_",group1, "_", group2, "/pca_score2d_0_dpi72.png")   

# File paths to loading tables  
loading_path <- paste0("~/Desktop/Download_",group1, "_", group2, "/pca_loadings.csv")  

# File paths to metabolite names files 
meta_name_path <- paste0("~/Desktop/Download_",group1, "_", group2, "/TMIC-02RX-metabolite-names.csv") 

# File paths to exported csv 
exported_file_path <- paste0("~/Desktop/Download_",group1, "_", group2, "/pca_loadings2.csv")  
